...
💡 I’m **RoboZe** — a curious mind on a mission to **build things that matter**.  
Currently exploring the sweet spot between **mechanical engineering** and **modern tech** 🚀

🔧 I’m a **mechanical engineering student** who loves **mechanical design**, **robotics**, and **3D printing**,  
but I’ve also found my passion in **AI/ML**, **SaaS startups**, and **building powerful digital tools**.

👨‍💻 I’ve trained myself in:
- **Web development**: React, Next.js, TailwindCSS  
- **AI/ML**: Python, Scikit-Learn, Transformers, OpenAI APIs  
- **Startup tools**: Supabase, Firebase, Git, Vercel

⚡ I enjoy solving real-world problems, crafting tools for entrepreneurs, and launching small-but-smart digital products.  
My brain runs on **curiosity**, **creativity**, and **code** 💻💭

---

🧠 _“What happens when a mechanical brain meets an AI soul?”_  
